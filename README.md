...
Quirks aims to be:
- **Fast** — Starts in under a second, runs anywhere
- **Modal** — Vim-style editing as a first-class citizen
- **Extensible** — Plugin architecture without bloat
- **Portable** — Linux first, then Windows and macOS
